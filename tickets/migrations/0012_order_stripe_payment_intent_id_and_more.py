...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tickets', '0011_merge_20260316_2341'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(storage=tickets.models.PdfStorage(), upload_to='tickets/pdfs')),
                ('is_sold', models.BooleanField(default=False)),
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='individual_pdfs', to='tickets.ticket')),
            ],
        ),
        migrations.CreateModel(
