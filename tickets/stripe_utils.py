...
def initialize_stripe():
    ...
    # If environment variable is empty or has the old expired key, use the fallback
    if not stripe_key or stripe_key.endswith('mksBBj'):
        logger.warning("Environment STRIPE_SECRET_KEY is invalid or expired, using fallback key")
