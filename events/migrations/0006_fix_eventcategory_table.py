# Data migration to drop and recreate EventCategory table with correct fields
...
class Migration(migrations.Migration):
    ...
    operations = [
        # First, remove the foreign key from Event model
        migrations.RemoveField(
            model_name='event',
            name='category',
        ),
        # Delete the EventCategory model
